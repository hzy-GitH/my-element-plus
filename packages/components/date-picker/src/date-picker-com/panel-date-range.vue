      ...
      <div :class="ppNs.e('body')">
        <div v-if="showTime" :class="drpNs.e('time-header')">
          <span :class="drpNs.e('editors-wrap')">
            <span :class="drpNs.e('time-picker-wrap')">
              <el-input size="small" :disabled="rangeState.selecting" :placeholder="t('el.datepicker.startDate')"
            ...
            <span v-clickoutside="handleMinTimeClose" :class="drpNs.e('time-picker-wrap')">
              ...
              <time-pick-panel :visible="minTimePickerVisible" :format="timeFormat" datetime-role="start"
                :parsed-value="leftDate" @pick="handleMinTimePick" />
            </span>
          </span>
          <span>
          ...
          <span :class="drpNs.e('editors-wrap')" class="is-right">
            <span :class="drpNs.e('time-picker-wrap')">
              <el-input size="small" :class="drpNs.e('editor')" :disabled="rangeState.selecting"
                :placeholder="t('el.datepicker.endDate')" :model-value="maxVisibleDate" :readonly="!minDate"
            ...
            <span v-clickoutside="handleMaxTimeClose" :class="drpNs.e('time-picker-wrap')">
              <el-input size="small" :class="drpNs.e('editor')" :disabled="rangeState.selecting"
                :placeholder="t('el.datepicker.endTime')" :model-value="maxVisibleTime" :readonly="!minDate"
              ...
              <time-pick-panel datetime-role="end" :visible="maxTimePickerVisible" :format="timeFormat"
                :parsed-value="rightDate" @pick="handleMaxTimePick" />
            </span>
          </span>
        </div>
        <div :class="[ppNs.e('content'), drpNs.e('content')]" class="is-left">
          <div :class="drpNs.e('header')">
            <button type="button" :class="ppNs.e('icon-btn')" :aria-label="t(`el.datepicker.prevYear`)"
              class="d-arrow-left" @click="leftPrevYear">
              <slot name="prev-year">
                <el-icon>
                  <d-arrow-left />
                </el-icon>
            ...
            <button v-show="leftCurrentView === 'date'" type="button" :class="ppNs.e('icon-btn')"
              :aria-label="t(`el.datepicker.prevMonth`)" class="arrow-left" @click="leftPrevMonth">
            ...
            <button v-if="unlinkPanels && leftCurrentView === 'date'" type="button" :disabled="!enableMonthArrow"
              :class="[
                ppNs.e('icon-btn'),
            ...
            <div>
              <span role="button" :class="drpNs.e('header-label')" aria-live="polite" tabindex="0"
                @keydown.enter="showLeftPicker('year')" @click="showLeftPicker('year')">
                {{ leftYearLabel }}
              </span>
              <span v-show="leftCurrentView === 'date'" role="button" aria-live="polite" tabindex="0" :class="[
          ...
          <date-table v-if="leftCurrentView === 'date'" ref="leftCurrentViewRef" selection-mode="range" :date="leftDate"
            ...
            :cell-class-name="cellClassName" :show-week-number="showWeekNumber" @changerange="handleChangeRange"
            @pick="handleRangePick" @select="onSelect" />
          <year-table v-if="leftCurrentView === 'year'" ref="leftCurrentViewRef" selection-mode="year" :date="leftDate"
            :disabled-date="disabledDate" :parsed-value="parsedValue" @pick="handleLeftYearPick" />
          <month-table v-if="leftCurrentView === 'month'" ref="leftCurrentViewRef" selection-mode="month"
            :date="leftDate" :parsed-value="parsedValue" :disabled-date="disabledDate" @pick="handleLeftMonthPick" />
        </div>
        <div :class="[ppNs.e('content'), drpNs.e('content')]" class="is-right">
          <div :class="drpNs.e('header')">
            ...
            <button v-if="unlinkPanels && rightCurrentView === 'date'" type="button" :disabled="!enableMonthArrow"
              :class="[
                ppNs.e('icon-btn'),
                { 'is-disabled': !enableMonthArrow },
            ...
            <button type="button" :aria-label="t(`el.datepicker.nextYear`)" :class="ppNs.e('icon-btn')"
              class="d-arrow-right" @click="rightNextYear">
              <slot name="next-year">
                <el-icon>
                  <d-arrow-right />
                </el-icon>
            ...
            <button v-show="rightCurrentView === 'date'" type="button" :class="ppNs.e('icon-btn')"
              :aria-label="t(`el.datepicker.nextMonth`)" class="arrow-right" @click="rightNextMonth">
              <slot name="next-month">
                <el-icon>
                  <arrow-right />
                </el-icon>
            ...
            <div>
              <span role="button" :class="drpNs.e('header-label')" aria-live="polite" tabindex="0"
                @keydown.enter="showRightPicker('year')" @click="showRightPicker('year')">
                {{ rightYearLabel }}
              </span>
              <span v-show="rightCurrentView === 'date'" role="button" aria-live="polite" tabindex="0" :class="[
                drpNs.e('header-label'),
          ...
          <year-table v-if="rightCurrentView === 'year'" ref="rightCurrentViewRef" selection-mode="year"
            :date="rightDate" :disabled-date="disabledDate" :parsed-value="parsedValue" @pick="handleRightYearPick" />
          <month-table v-if="rightCurrentView === 'month'" ref="rightCurrentViewRef" selection-mode="month"
            :date="rightDate" :parsed-value="parsedValue" :disabled-date="disabledDate" @pick="handleRightMonthPick" />
        </div>
      </div>
    </div>
